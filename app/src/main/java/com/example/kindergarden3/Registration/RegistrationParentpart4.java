...
public class RegistrationParentpart4 extends AppCompatActivity implements View.OnClickListener {
    ...
    */
    ...
    private EditText editNameParent, editEmailParent, editPhoneParent, editLogin, editPass, editPassRepeat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reg_parent_part4);
        ...
        editNameParent = (EditText) findViewById(R.id.editNameParent);
        editEmailParent = (EditText) findViewById(R.id.editEmailParent);
        editPhoneParent = (EditText) findViewById(R.id.editPhoneParent);
        editLogin = (EditText) findViewById(R.id.editLogin);
        editPass = (EditText) findViewById(R.id.editPass);
        editPassRepeat = (EditText) findViewById(R.id.editPassRepeat);
        spParent = (Spinner) findViewById(R.id.spParent);

        editNameParent.setTypeface(fontRobotoRegular);
        editEmailParent.setTypeface(fontRobotoRegular);
        editPhoneParent.setTypeface(fontRobotoRegular);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnFinish:
                startActivity(new Intent(RegistrationParentpart4.this, Tab.class));
                break;
